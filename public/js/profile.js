...
var fetchProfile = function () { return __awaiter(_this, void 0, void 0, function () {
    var token, response, data, profileImageElement, error_1;
        ...
        switch (_a.label) {
            ...
            case 3:
                ...
                if (response.ok && data.user) {
                    document.getElementById("username").textContent = "Nom d'utilisateur: ".concat(data.user.username || "Non disponible");
            ...
            case 4:
                error_1 = _a.sent();
                console.error("Erreur lors de la récupération du profil", error_1);
                window.location.href = "/login.html";
                return [3 /*break*/, 5];
