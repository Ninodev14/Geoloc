...
var checkAuthentication = function () { return __awaiter(_this, void 0, void 0, function () {
    var token, response, data, usernameElement, profileImageElement, error_1;
        ...
        switch (_a.label) {
            ...
            case 3:
                ...
                if (response.ok && data.user) {
                    ...
                    profileImageElement = document.getElementById("profile-image");
                    if (usernameElement) {
                        usernameElement.textContent = data.user.username;
                    }
                    if (profileImageElement && data.user.profileImage) {
                        profileImageElement.src = "http://localhost:5000/".concat(data.user.profileImage);
                    }
                }
                else {
