        ...
        switch (_a.label) {
            ...
            case 2:
                ...
                if (userData.profileImage) {
                    document.getElementById("profile-image").src = "https://galiotest.osc-fr1.scalingo.io/".concat(userData.profileImage);
                }
                loadGeocaches();
                return [3 /*break*/, 4];
            case 3:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, fetch("https://galiotest.osc-fr1.scalingo.io/validated-geocaches", {
                        headers: {
                            Authorization: "Bearer ".concat(token),
                        },
                    })];
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            return [4 /*yield*/, fetch("https://galiotest.osc-fr1.scalingo.io/geocache/".concat(geo._id), {
                                                    method: "DELETE",
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                token = localStorage.getItem("token");
                return [4 /*yield*/, fetch("https://galiotest.osc-fr1.scalingo.io/validate-geocache/".concat(geocacheId), {
                        method: "POST",
                        headers: {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                token = localStorage.getItem("token");
                return [4 /*yield*/, fetch("https://galiotest.osc-fr1.scalingo.io/comment", {
                        method: "POST",
                        headers: {
                            "Content-Type": "application/json",
                            Authorization: "Bearer ".concat(token),
