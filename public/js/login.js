...
var _this = this;
(_a = document
    .getElementById("loginForm")) === null || _a === void 0 ? void 0 : _a.addEventListener("submit", function (e) { return __awaiter(_this, void 0, void 0, function () {
    var emailInput, passwordInput, messageElement, email, password, response, data, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 4, , 5]);
                return [4 /*yield*/, fetch("https://galiotest.osc-fr1.scalingo.io/login", {
                        method: "POST",
